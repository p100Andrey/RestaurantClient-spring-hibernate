...
<header>
    ...
    <table style="background: white; width: 800px">
        <tr>
            <td>
                <h1>
                    <big><big><big><big><big><big><a href="dish"
            ...
            <td>
                ...
                <table style="background: #0cc316">
                    <tr>
                        <td><b><a href="dish" style="font-size:20px;color:white">&nbsp&nbsp Main Page &nbsp&nbsp</a></b></td>
                        ...
                        <td><b><a href="worker" style="font-size:20px;color:white">&nbsp&nbsp Workers &nbsp&nbsp</a></b></td>
